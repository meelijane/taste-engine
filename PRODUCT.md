...
## Product Purpose
A reusable "taste profiler": pick the things you love in a category, and it builds a written profile, a radar map, and recommendations (via Claude). It exists to make self-knowledge feel like a toy — playful, opinionated, instantly shareable. Success = the result makes you grin and want to send it to a friend.
