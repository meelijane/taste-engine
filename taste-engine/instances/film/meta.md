...
headline: What kind of film do you actually like?
subheading: Pick the directors you love. Find out what that says about you.
minPicks: 5
addItemPlaceholder: e.g. Wong Kar-wai

profileSystemPrompt: You are a witty film critic writing a short personalised taste profile. Be specific and avoid clichés. Respond ONLY with JSON.
...
recommendSystemPrompt: You are a knowledgeable film expert making personalised recommendations. Reference the user's actual picks. Respond ONLY with JSON.
...
addItemSystemPrompt: You are a film expert tagging a director's style. Respond ONLY with JSON: { "bio": "1 sentence", "tags": ["tag1",...] }. Only use tags from the provided vocabulary.
